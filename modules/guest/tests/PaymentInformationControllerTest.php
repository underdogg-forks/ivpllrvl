...
class PaymentInformationControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'guest/paymentinformation/form'],
        ['action' => 'paypal', 'verb' => 'GET', 'uri' => 'guest/paymentinformation/paypal'],
        ['action' => 'stripe', 'verb' => 'GET', 'uri' => 'guest/paymentinformation/stripe']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(PaymentInformationController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(PaymentInformationController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(PaymentInformationController::class);
