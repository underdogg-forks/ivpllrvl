...
class ViewControllerTest extends TestCase
{
    ...
    {
        // Arrange
        $actions = $this->discoverPublicControllerActions(ViewController::class);

        // Act
        $routes = array_map(fn (string $action): array => $this->guessRouteForControllerAction(ViewController::class, $action), $actions);
    ...
    public function it_uses_post_routes_for_ajax_controller_actions(): void
    {
        ...
        // Assert
        if (!str_contains(ViewController::class, 'AjaxController')) {
    ...
    {
        // Arrange
        $controllerReflection = new \ReflectionClass(ViewController::class);
