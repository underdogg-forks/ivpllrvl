...
class PaymentsAjaxControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'add', 'verb' => 'POST', 'uri' => 'payments/paymentsajax/add'],
        ['action' => 'modal_add_payment', 'verb' => 'POST', 'uri' => 'payments/paymentsajax/modal_add_payment']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(PaymentsAjaxController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(PaymentsAjaxController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(PaymentsAjaxController::class);
