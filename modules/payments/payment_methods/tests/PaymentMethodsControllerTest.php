...
class PaymentMethodsControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'payment_methods/index'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'payment_methods/form'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'payment_methods/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'payment_methods/delete/{id}']
    ];
