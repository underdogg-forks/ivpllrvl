...
class InvoiceGroupsControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'invoice_groups/index'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'invoice_groups/form'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'invoice_groups/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'invoice_groups/delete/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(InvoiceGroupsController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(InvoiceGroupsController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(InvoiceGroupsController::class);
