...
class ImportControllerTest extends TestCase
{
    ...
    {
        // Arrange
        $actions = $this->discoverPublicControllerActions(ImportController::class);

        // Act
        $routes = array_map(fn (string $action): array => $this->guessRouteForControllerAction(ImportController::class, $action), $actions);
    ...
    public function it_uses_post_routes_for_ajax_controller_actions(): void
    {
        ...
        // Assert
        if (!str_contains(ImportController::class, 'AjaxController')) {
    ...
    {
        // Arrange
        $controllerReflection = new \ReflectionClass(ImportController::class);
