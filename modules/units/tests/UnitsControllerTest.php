...
class UnitsControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'units/index'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'units/form'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'units/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'units/delete/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(UnitsController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(UnitsController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(UnitsController::class);
