...
class EmailTemplatesAjaxControllerTest extends TestCase
{
    ...
    {
        // Arrange
        $actions = $this->discoverPublicControllerActions(EmailTemplatesAjaxController::class);

        // Act
        $routes = array_map(fn (string $action): array => $this->guessRouteForControllerAction(EmailTemplatesAjaxController::class, $action), $actions);
    ...
    public function it_uses_post_routes_for_ajax_controller_actions(): void
    {
        ...
        // Assert
        if (!str_contains(EmailTemplatesAjaxController::class, 'AjaxController')) {
    ...
    {
        // Arrange
        $controllerReflection = new \ReflectionClass(EmailTemplatesAjaxController::class);
