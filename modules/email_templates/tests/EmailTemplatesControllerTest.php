...
class EmailTemplatesControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'email_templates/index'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'email_templates/form'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'email_templates/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'email_templates/delete/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(EmailTemplatesController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(EmailTemplatesController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(EmailTemplatesController::class);
