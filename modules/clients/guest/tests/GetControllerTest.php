...
class GetControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'attachment', 'verb' => 'GET', 'uri' => 'guest/get/attachment'],
        ['action' => 'get_file', 'verb' => 'GET', 'uri' => 'guest/get/get_file'],
        ['action' => 'show_files', 'verb' => 'GET', 'uri' => 'guest/get/show_files']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(GetController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(GetController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(GetController::class);
