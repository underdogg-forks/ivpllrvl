...
class UserClientsControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'user_clients/index'],
        ['action' => 'create', 'verb' => 'GET', 'uri' => 'user_clients/form'],
        ['action' => 'create', 'verb' => 'GET', 'uri' => 'user_clients/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'user_clients/delete/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(UserClientsController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(UserClientsController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(UserClientsController::class);
