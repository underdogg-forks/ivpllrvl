...
class ProductsControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'products/index'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'products/form'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'products/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'products/delete/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(ProductsController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(ProductsController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(ProductsController::class);
