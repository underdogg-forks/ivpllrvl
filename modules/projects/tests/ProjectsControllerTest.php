...
class ProjectsControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'projects/index'],
        ['action' => 'view', 'verb' => 'GET', 'uri' => 'projects/view/{id}'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'projects/form'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'projects/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'projects/delete/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(ProjectsController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(ProjectsController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(ProjectsController::class);
