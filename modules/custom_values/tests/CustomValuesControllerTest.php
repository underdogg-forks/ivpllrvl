...
class CustomValuesControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'custom_values'],
        ['action' => 'create', 'verb' => 'GET', 'uri' => 'custom_values/create'],
        ['action' => 'create', 'verb' => 'GET', 'uri' => 'custom_values/create/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'custom_values/delete/{id}'],
        ['action' => 'field', 'verb' => 'GET', 'uri' => 'custom_values/field'],
        ['action' => 'field', 'verb' => 'GET', 'uri' => 'custom_values/field/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(CustomValuesController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(CustomValuesController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(CustomValuesController::class);
