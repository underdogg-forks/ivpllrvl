...
class TaxRatesControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'delete', 'verb' => 'POST', 'uri' => 'tax_rates/taxrates/delete'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'tax_rates/taxrates/form'],
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'tax_rates/taxrates/index']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(TaxRatesController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(TaxRatesController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(TaxRatesController::class);
