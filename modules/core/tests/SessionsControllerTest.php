...
class SessionsControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'sessions/index'],
        ['action' => 'login', 'verb' => 'GET', 'uri' => 'sessions/login'],
        ['action' => 'logout', 'verb' => 'GET', 'uri' => 'sessions/logout']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(SessionsController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(SessionsController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(SessionsController::class);
