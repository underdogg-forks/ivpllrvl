...
class SettingsAjaxControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'get_cron_key', 'verb' => 'POST', 'uri' => 'settings/settingsajax/get_cron_key']
    ];
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(SettingsAjaxController::class);
