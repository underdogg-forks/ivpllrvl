...
class LayoutControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'load_view', 'verb' => 'GET', 'uri' => 'layout/header'],
        ['action' => 'load_view', 'verb' => 'GET', 'uri' => 'layout/footer'],
        ['action' => 'load_view', 'verb' => 'GET', 'uri' => 'layout/sidebar']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(LayoutController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(LayoutController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(LayoutController::class);
