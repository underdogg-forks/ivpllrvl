...
class TasksControllerTest extends TestCase
{
    ...
    private const EXPECTED_ROUTES = [
        ['action' => 'index', 'verb' => 'GET', 'uri' => 'tasks/index'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'tasks/form'],
        ['action' => 'form', 'verb' => 'GET', 'uri' => 'tasks/form/{id}'],
        ['action' => 'delete', 'verb' => 'GET', 'uri' => 'tasks/delete/{id}']
    ];
    ...
    {
        /* Arrange */
        $actions = $this->discoverPublicControllerActions(TasksController::class);
    ...
    {
        /* Arrange */
        $registeredRoutes = $this->discoverRouteDefinitionsForController(TasksController::class);
    ...
    {
        /* Arrange */
        $controllerReflection = new \ReflectionClass(TasksController::class);
